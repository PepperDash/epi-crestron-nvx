...
public class NvxDeviceJoinMap : JoinMapBaseAdvanced
    ...
    [JoinName("AudioRoute")]
    public JoinDataComplete AudioRoute = new(
    ...
    [JoinName("HdmiIn1Present")]
    public JoinDataComplete HdmiIn1Present = new(
        new JoinData { JoinNumber = 6, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    [JoinName("HdmiIn2Present")]
    public JoinDataComplete HdmiIn2Present = new(
        new JoinData { JoinNumber = 7, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    [JoinName("HdmiOutputDisableByHdcp")]
    public JoinDataComplete HdmiOutputDisableByHdcp = new(
    ...
    [JoinName("HdmiOutputResolution")]
    public JoinDataComplete HdmiOutputResolution = new(
        new JoinData { JoinNumber = 8, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    [JoinName("MulticastAudioAddress")]
    public JoinDataComplete MulticastAudioAddress = new(
    ...
    [JoinName("NaxInput")]
    public JoinDataComplete NaxInput = new(
    ...
    [JoinName("NaxRoute")]
    public JoinDataComplete NaxRoute = new(
    ...
    [JoinName("StreamStarted")]
    public JoinDataComplete StreamStarted = new(
        new JoinData { JoinNumber = 2, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    [JoinName("DanteInput")]
    public JoinDataComplete DanteInput = new(
    ...
    [JoinName("SupportsNax")]
    public JoinDataComplete SupportsNax = new(
        new JoinData { JoinNumber = 12, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    [JoinName("SupportsVideowall")]
    public JoinDataComplete SupportsVideowall = new(
    ...
    [JoinName("UsbRoute")]
    public JoinDataComplete UsbRoute = new(
    ...
    [JoinName("VideoRoute")]
    public JoinDataComplete VideoRoute = new(
        new JoinData { JoinNumber = 1, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
    ...
    [JoinName("VideowallMode")]
    public JoinDataComplete VideowallMode = new(
        new JoinData { JoinNumber = 9, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
    ...
    [JoinName("VideoAspectRatioMode")]
    public JoinDataComplete VideoAspectRatioMode = new(
        new JoinData { JoinNumber = 11, JoinSpan = 1 },
        new JoinMetadata
            {
            JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
