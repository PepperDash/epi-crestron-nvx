...
public static class NaxInputExtensions
{
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'Hdmi1'");
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'Hdmi2'");
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'Analog'");
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'PrimaryStream'");
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'SecondaryStream'");
    ...
    {
        Debug.LogInformation(device, "Switching Nax Input to : 'Automatic'");
