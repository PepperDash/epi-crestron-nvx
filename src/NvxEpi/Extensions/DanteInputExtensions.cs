...
public static class DanteInputExtensions
{
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'Hdmi1'");
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'Hdmi2'");
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'Analog'");
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'PrimaryStream'");
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'SecondaryStream'");
    ...
    {
        Debug.LogInformation(device, "Switching Dante Input to : 'Automatic'");
