...
public static class AudioInputExtensions
{
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'Hdmi1'");
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'Hdmi2'");
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'Analog'");
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'PrimaryStream'");
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'SecondaryStream/DM NAX'");
    ...
    {
        Debug.LogInformation(device, "Switching Audio Input to: 'Automatic'");
